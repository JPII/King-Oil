...
public class CommandHandler {
	...
	public CommandHandler(ArrayList<Command> commands) {
		KingOil.getDebugWindow().printInfo("Registering commands");
		
		for(Command c : commands) {
			registerCommand(c);
		}
		
		KingOil.getDebugWindow().printInfo(commands.size() + " commands registered");
	}
	...
	public void parseCommand(String command) {
		...
		if(!isCommand) {
			KingOil.getDebugWindow().printError("'" + command + "' is not a registered command");
		}
	}
